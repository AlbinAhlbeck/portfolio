    ...
    <div className="flex flex-col items-center p-4">
      ...
      <div className="flex flex-wrap gap-24 justify-center">
        ...
        <div>
          ...
          <ProgressBar description="I am creative person so I like to make things look pretty so HTML and CSS have always been very fun for me. I have not had any issues with fullfilling a design given to me from a UX/UI designer." label="Azure" progress={70} />
          <ProgressBar description="Vue.js is my strongest frontend javascript framework. I have experience in using it together with Vuex for state managment. Also have experience working with vue-i18n for localization" label="Jira" progress={80} />
          <ProgressBar description="I learned React.js together with Next.js and I really like it and would like to use it more." label="React.js" progress={60} />
          <ProgressBar description="I have used Next.js in a professional setting and did not have many issues with it due to it being very powerful and easy to use for routing etc." label="Github" progress={60} />
        </div>
        <Card>
          <p>Some information about me</p>
          <p>Location: Sweden, Malmö</p>
          <p>Born: 2000</p>
        </Card>
      </div>
    </div>
