  ...
  export default function ProjectPage() {
    return (
        ...
        <div className="flex flex-col items-center min-w-fit">
          ...
          <p className="mx-8 mb-8 max-w-4xl">This is the project where I learned Next.js and React.js. I had not previously worked with these frameworks. But me and my manager were confident it would not be a problem. We delivered great quality on a tight deadline and the customer was delighted.</p>
              ...
              <AccordionContent>
                ...
                <Accordion className="mt-4 mx-8" type="single" collapsible>
                  <AccordionItem value="iot">
                    <AccordionTrigger className="text-lg">Strapi</AccordionTrigger>
                    <AccordionContent>
                  ...
                  <AccordionItem value="apis">
                    <AccordionTrigger className="text-lg">Mobile first</AccordionTrigger>
                    <AccordionContent>
